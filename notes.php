...
{
    if (!isset($_FILES['note_image']) || $_FILES['note_image']['error'] === UPLOAD_ERR_NO_FILE) {
        return null;
    }
    if ($_FILES['note_image']['error'] !== UPLOAD_ERR_OK) {
        return false;
    }
...
function decrypt_note_value(?string $value): string
{
    ...
    if (!note_value_is_encrypted($value)) {
        return $value;
    }
...
<div class="container py-4 py-md-5">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
            <h2 class="h3 fw-bold mb-1"><?php echo htmlspecialchars(t('notes')); ?></h2>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-5">
                        ...
                        <input class="form-control rounded-3" name="note_title" placeholder="Note title" maxlength="190" required autocomplete="off" autocapitalize="off" spellcheck="false" value="<?= $editNote ? htmlspecialchars($editNote['title']) : '' ?>">
                    </div>
